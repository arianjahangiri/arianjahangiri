...
const AddCategory = () => {
  ...
  useEffect(() => {
    fetch("https://arianjahangiri.vercel.appi.vercel.app/api/categories/home-menu")
      .then((res) => res.json())
      .then((data) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch("https://arianjahangiri.vercel.appi.vercel.app/api/product", {
        method: "POST",
        body: formData,
      });
