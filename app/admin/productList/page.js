...
const StockListPage = () => {
  ...
  const handleEdit = async (e, productId) => {
    ...
    try {
      ...
      const res = await fetch(`https://arianjahangiri.vercel.app/api/product/${productId}`);
      ...
      // ارسال FormData کامل
      const updateRes = await fetch(`https://arianjahangiri.vercel.app/api/product/${productId}`, {
        method: "PUT",
        body: formData,
      });
